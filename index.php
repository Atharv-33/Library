...
<?php
  ...
  <section id="projects">
    <div class="projects container">
      <div class="projects-header">
        <h1 class="section-title">OUR <span>LABRARY GALLARY</span></h1>
      </div>
  ...
  <section id="about">
    <div class="about container">
      ...
      <div class="col-right">
        ...
        <a  class="cta"> Dr. Mrs. Deshpande </a>
  ...
  <section id="about">
    <div class="about container">
      <div class="col-left">
        <div class="about-img">
          <img src="./images/plate-1.jpeg" alt="img">
        </div>
      </div>
      <div class="col-right">
        <h1 class="section-title">About <span>Our Library</span></h1>
        <h2>Bhausaheb vartak Library</h2>
        <p>The library of HPT Arts and RYK Science College serves as a vital resource hub , fostering academic excellence and supporting intellectual growth of its students and its faculty  . Sitauted at center of the college library boasts at a vast collection of books , periodicals,journals etc ..  </p>
      
        <a  class="cta">Welcome to Our Library </a>
        <span class="lt"> 
           <!-- <h2>Welcome to Our Library</h2> -->
                        <!-- <p>Explore our collection of books, journals, and digital resources. Our library is dedicated to supporting the academic needs of students and faculty.</p> -->
                        <h2>Library Hours</h2>
    ...
    <div class="footer container">
      ...
      <div class="social-icon">
        <div class="social-item">
          <a href="#"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></a>
        </div>
      ...
      <p>Copyright © 2020 HPT Arts & Ryk science college ,Nashik . All rights reserved</p>
    </div>
  </section>-->
  <!-- End Footer -->
