  			...
  			<div style="color: white; margin-left:60px; font-size: 20px;">
                ...
                { 	
                 ...
                 echo "<div style='margin-left:10px;'>
                    ...
                    echo"<br>";
                    echo "<span style='margin-right:10x;'> Welcome </span>  ".$_SESSION['login_user']; 
                }
                ?>
            </div><br><br>
...
<div class="srch">
		<br>
		<center><form method="post" action="" name="form1">
	...
	if(isset($_SESSION['login_user']))
	{
		...
		if(mysqli_num_rows($res)==0)
			{
				echo "<h2><b>";
				echo "<p align='center' style='color:yellow;'>There's no pending request.</p>";
				echo "</h2></b>";
			}
		else
		{
