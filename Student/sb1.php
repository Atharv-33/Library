...
<body>
  ...
  <div class="h"><a href="expired.php">Request List</a></div>
</div>
</div>
<div id="main">
			...
			if(isset($_SESSION['login_user']))
			{
				 ...
				 if($_POST['bid'] == 0 )
				 {
					...
					<script type="text/javascript">
						alert(" NO Book Found For Given Book Id...Please Enter Valid Book Id...");
						window.location="sb1.php";
					</script>
				<?php
